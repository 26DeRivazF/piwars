...
class UltraBorg_tk(tkinter.Tk):
    ...
    def poll(self):
        ...
        distance1 = UB.GetDistance1()
        distance2 = UB.GetDistance2()
        distance3 = UB.GetDistance3()
        distance4 = UB.GetDistance4()
        ...
        if distance1 is None or distance1 == 0:
            self.lblDistance1['text'] = 'None'
        else:
            self.lblDistance1['text'] = '%4d' % (int(distance1))
        if distance2 is None or distance2 == 0:
            self.lblDistance2['text'] = 'None'
        else:
            self.lblDistance2['text'] = '%4d' % (int(distance2))
        if distance3 is None or distance3 == 0:
            self.lblDistance3['text'] = 'None'
        else:
            self.lblDistance3['text'] = '%4d' % (int(distance3))
        if distance4 is None or distance4 == 0:
            self.lblDistance4['text'] = 'None'
        else:
            self.lblDistance4['text'] = '%4d' % (int(distance4))
